      ...
      <div className="container-fluid">
        <fieldset disabled={AccionABMC === 'C'}>
          ...
          <div className="row">
            ...
            <div className="col-sm-8 col-md-6">
              <select name="IdArticuloFamilia" className="form-control">
          ...
          <div className="row">
            ...
            <div className="col-sm-8 col-md-6">
              <input type="date" name="FechaAlta" className="form-control" />
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-sm-8 col-md-6">
              <select name="Activo" className="form-control" disabled>
