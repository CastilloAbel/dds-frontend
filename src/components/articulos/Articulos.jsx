...
import { articulosFamiliasMockService as articulosfamiliasService } from '../../services/articulosfamilias-mock-services';
...
function Articulos() {
  ...
  return (
    <div>
      ...
      {AccionABMC !== "L" && <ArticulosRegistro {...{ AccionABMC, ArticulosFamilias, Item, Grabar, Volver }} /> }
    </div>
  );
}
